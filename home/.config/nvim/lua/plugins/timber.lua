    ...
    require('timber').setup {
      log_templates = {
        default = {
          ...
          javascript = [[console.log("\x1b[33m%s\x1b[0m", "%log_marker %log_target", %log_target)]],
          typescript = [[console.log("\x1b[33m%s\x1b[0m", "%log_marker %log_target", %log_target)]],
          jsx = [[console.log("%log_marker %log_target", %log_target)]],
          tsx = [[console.log("%log_marker %log_target", %log_target)]],
        },
        plain = {
          javascript = [[console.log("\x1b[33m%s\x1b[0m", "%log_marker", %insert_cursor)]],
          typescript = [[console.log("\x1b[33m%s\x1b[0m", "%log_marker", %insert_cursor)]],
