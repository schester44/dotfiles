...
Color.new('light_orange_bg', M.adjust_transparency(palette.light_orange, palette.bg, 0.1))
Color.new('light_purple_bg', M.adjust_transparency(palette.purple, palette.bg, 0.1))
Color.new('light_green_bg', M.adjust_transparency(palette.light_green, palette.bg, 0.1))
Color.new('light_red_bg', '#663E46')
Color.new('light_blue_bg', M.adjust_transparency(palette.light_blue, palette.bg, 0.1))
Color.new('light_pink_bg', M.adjust_transparency(palette.light_pink, palette.bg, 0.1))
Color.new('light_yellow_bg', M.adjust_transparency(palette.light_yellow, palette.bg, 0.1))

--------------------------------------------------------------------------------
--  NOTE: colors {{{
--------------------------------------------------------------------------------
Color.new('bg_light', palette.bg_light)
Color.new('bg_lighter', palette.bg_lighter)
Color.new('bg_dark', palette.bg_dark)
Color.new('bg', palette.bg)
