...
Group.new('DiagnosticUnderlineError', nil, nil, styles.underline, colors.muted_red)
Group.new('DiagnosticUnderlineHint', nil, nil, styles.underline, colors.light_pink)
Group.new('DiagnosticUnderlineInfo', nil, nil, styles.underline, colors.light_blue)
Group.new('DiagnosticUnderlineWarn', nil, nil, styles.underline, colors.light_yellow)
