...
-- ╰──────────────────────────────────────────────────────────╯
--
local Color = require('graphite.utils').Color
local palette = require 'graphite.palette'
local M = {}
...
-- Load highlights
--------------------------------------------------------------------------------
require 'graphite.theme'
require 'graphite.syntax'
require 'graphite.plugins'
require 'graphite.languages'
