...
return {
  ...
  opts = {
    ...
    spec = {
      ...
      { '<leader>T', group = 'Toggle', icon = { icon = icons.toggle, color = 'yellow' } },
      { '<leader>t', group = 'Test/Terminal', icon = { icon = icons.test, color = 'yellow' } },
      ...
      { '<leader>p', group = 'Profiler', icon = { icon = '⚡', color = 'green' } },
    },
  },
}
